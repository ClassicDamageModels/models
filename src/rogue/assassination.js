...
export default ({
  ...
  */
  ...
  // console.log('MUTILATES_TO_REACH_SND_CPS', MUTILATES_TO_REACH_SND_CPS)
  ...
  // const ROTATION_DURATION_SECONDS = Math.max(
  ...
  // console.log('ROTATION_ENERGY_CONSUMPTION', ROTATION_ENERGY_CONSUMPTION)
