...
export default ({
  ...
  */
  ...
  const OH_WINDFURY_DAMAGE =
    (OH_WEAPON_DAMAGE * 0.5 + (AP_COEFFICIENT * (stats.attackpower + 445 * 1.4)) / 14) *
    1.1 * // Talent: Weapon Mastery
    ARMOR_MULTIPLIER *
    target.multipliers.physical
  ...
  const MH_WINDFURY_HIT_COMPONENT =
    YELLOW_HIT_CHANCE * (1 - ATTACK_TABLE_YELLOW.crit) * MH_WINDFURY_DAMAGE
  const OH_WINDFURY_HIT_COMPONENT =
    YELLOW_HIT_CHANCE * (1 - ATTACK_TABLE_YELLOW.crit) * OH_WINDFURY_DAMAGE

  const MH_WINDFURY_CRIT_COMPONENT =
    YELLOW_HIT_CHANCE * ATTACK_TABLE_YELLOW.crit * MH_WINDFURY_DAMAGE * 2
  const OH_WINDFURY_CRIT_COMPONENT =
    YELLOW_HIT_CHANCE * ATTACK_TABLE_YELLOW.crit * OH_WINDFURY_DAMAGE * 2
