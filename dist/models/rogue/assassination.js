...
var _default = function _default(_ref) {
  ...
  var MUTILATES_TO_REACH_RUPTURE_CPS = (RUPTURE_CP - RUTHLESSNESS_CHANCE - T4_4PC_CHANCE) / CP_PER_MUTILATE;
  var ROTATION_ENERGY_CONSUMPTION = MUTILATES_TO_REACH_SND_CPS * MUTILATE_COST + SND_COST - SND_CP * DISCOUNT_PER_CP + MUTILATES_TO_REACH_RUPTURE_CPS * MUTILATE_COST + RUPTURE_COST - RUPTURE_CP * DISCOUNT_PER_CP;
  var ROTATION_DURATION_SECONDS = 20;
  var EXTRA_ENERGY = ENERGY_PER_SECOND * ROTATION_DURATION_SECONDS - ROTATION_ENERGY_CONSUMPTION;
